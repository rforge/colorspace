...
\Abstract{
  ...
  and do not introduce optical illusions or systematic bias. This article
discusses
...
%% only for statreport version:
%% \fronttitle{Escaping RGBland: Selecting Colors for Statistical Graphics}
%% \frontauthor{Achim Zeileis, Kurt Hornik, Paul Murrell}
%% \frontnumber{61}
%% \frontdate{November 2007}
%% \frontpage
%% \maketitle
...
if(generate_png) {
  ...
  plot_bkde2D(dens, col = rev(heat_hcl(33, c = 0, l = c(30, 90), power = c(1/5, 1.3))))
  plot_bkde2D(dens, col = rev(heat.colors(33)))
  plot_bkde2D(dens, col = rev(heat_hcl(33, c = c(80, 30), l = c(30, 90), power = c(1/5, 1.3))))
  dev.off()
}
@
...
if(generate_png) {
  ...
  plot(0, 0, type="n", xlim = c(0, 0.03), ylim = c(0, 1),
    xaxs = "i", yaxs = "i", axes = FALSE, xlab = "", ylab="")
  abline(v = seq(from = 0, to = 0.03, length.out = 99), lwd = 6, col = 
    rev(heat_hcl(99, c = c(80, 30), l = c(30, 90), power = c(1/5, 1.3))))
  box()
  plot(0, 0, type="n", xlim = c(0, 0.03), ylim = c(0, 1),
    xaxs = "i", yaxs = "i", axes = FALSE, xlab = "", ylab="")
  abline(v = seq(from = 0, to = 0.03, length.out = 99), lwd = 6, col = 
    rev(heat_hcl(99, c = 0, l = c(30, 90), power = c(1/5, 1.3))))
  box()
  axis(1, cex.axis = 1.8)
  dev.off()
}
...
\citep{color:Ware:1988,color:Levkowitz+Herman:1992}, i.e., rely
...
port to other statistical software systems. Starting from version~0.96, \pkg{colorspace}
\citep{color:Ihaka+Murrell+Hornik+Zeileis:2008} also includes
...
\citep{color:Wickham:2008} are also based on similar ideas to 
