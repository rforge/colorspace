...
\Abstract{
  ...
  and do not introduce optical illusions or systematic bias. This article discusses
...
port to other statistical software systems. Starting from version~0.97, %% FIXME
...
{color:Meyer+Zeileis+Hornik:2008} Qualitative palettes are provided by
