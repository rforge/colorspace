...
which is a transformation of CIELUV color space \citep[see][]{color:Wiki+CIELUV:2007}.
...
Some more more illustrations are presented in Section~\ref{sec:illustrations}.
...
%% 
%% We are thankful to David Meyer, Ross Ihaka, Ken Knoblauch, Brian~D.~Ripley,
