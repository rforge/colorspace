...
```{r eustockmarkets-titanic, echo = FALSE, fig.height = 4, fig.width = 10, out.width = "\\textwidth", fig.cap = "Time series plot of \\code{EuStockMarkets} data with \\code{qualitative\\_hcl(4, \"Dark 3\")} palette."}
...
```{r iris-diamonds, echo = FALSE, fig.height = 4, fig.width = 5, out.width = "0.49\\textwidth", fig.cap = "Foo."}
library("ggplot2")
ggplot(iris, aes(x = Sepal.Length, fill = Species)) + geom_density(alpha = 0.6) +
  scale_fill_discrete_qualitative(palette = "Dark 3")
set.seed(1)
...
Finally, the diverging "Green-Brown" palette is depicted below. It simply combines a green
and a brown/yellow sequential single-hue palette, both with triangular chroma trajectory.
