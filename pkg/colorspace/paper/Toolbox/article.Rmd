...
specifications in many systems based on the corresponding hex codes
...
* `polarLUV()` and `polarLAB()` take polar coordinates in the UV plane
  and AB plane, respectively. Specifically, the polar coordinates of the LUV
  model are known as the HCL (Hue-Chroma-Luminance) model [@color:Wiki+HCL]. These capture the
