...
```{r hcl-palettes, fig.height = 6.75, fig.width = 12, out.width = "\\textwidth", fig.cap = "Overview of available predefined palettes in \\pkg{colorspace}."}
library("colorspace")
...
```{r eustockmarkets-plot, echo = FALSE, warning = FALSE, fig.height = 4, fig.width = 6, out.width = "0.75\\textwidth", fig.cap = "Time series plot of \\code{EuStockMarkets} data with \\code{qualitative\\_hcl(4, \"Dark 3\")} palette."}
...
```{r titanic-plot, echo = FALSE, fig.height = 4, fig.width = 6, out.width = "0.75\\textwidth", fig.cap = "Foo."}
ttnc <- margin.table(Titanic, c(1, 4))[, 2:1]
par(mar = c(5, 4, 1, 1))
...
```{r iris-ggplot, fig.height = 4, fig.width = 6, out.width = "0.75\\textwidth", fig.cap = "Foo."}
library("ggplot2")
...
```{r diamonds-ggplot, fig.height = 4, fig.width = 6, out.width = "0.75\\textwidth", fig.cap = "Foo."}
...
```{r spec-qualitative, fig.width = 5, fig.height = 5, out.width = "0.5\\textwidth", fig.cap = "Foo."}
...
```{r spec-sequential, fig.width = 5, fig.height = 5, out.width = "0.5\\textwidth", fig.cap = "Foo."}
...
```{r spec-diverging, fig.width = 5, fig.height = 5, out.width = "0.5\\textwidth", fig.cap = "Foo."}
...
```{r spec-rainbow, fig.width = 5, fig.height = 7.5, out.width = "0.5\\textwidth", fig.cap = "Foo."}
...
```{r choose_palette, echo = FALSE, out.width = "\\textwidth", fig.cap="Foo."}
...
```{r choose_color, echo = FALSE, out.width = "\\textwidth", fig.cap="Foo."}
