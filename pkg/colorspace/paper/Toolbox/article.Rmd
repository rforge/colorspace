...
Color is an integral and omnipresent element of many statistical graphics and data
...
Finally, some further color manipulation utilities are highlighted in Section\ \ref{sec:manipulation_utilities}
...
\pkg{roloc} [@color:roloc; @color:roloc2] also provides color conversions,
...
replication materials for most examples are not only provided for both \proglang{R}
and \proglang{Python}.
