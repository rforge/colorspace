...
\subtitle{Reto Stauffer, Achim Zeileis\\EGU2020-7173}
\author{\vspace*{-6.5cm}\hspace*{12.5cm}\includegraphics[width=1.6cm]{palmfooter.png}\\[5.5cm]\vspace{-1.5em}} %% -6.83 with "for Statistical Graphics"
\URL{http://colorspace.R-Forge.R-project.org/}
...
%%\textbf{Qualitative:} For categorical information.\\
%%Constant chroma and luminance.
%%
%%\bigskip
%%
...
%%\textbf{Sequential:} For ordered/numeric information (i.e., high to low).\\
%%Monotonic increase/decrease of chroma and luminance.
%%
%%\bigskip
%%
...
%%\textbf{Diverging:} For ordered/numeric information around a central neutral value.\\
%%Symmetric change in chroma and luminance.
%%
%%
%%\end{frame}
...
\setkeys{Gin}{width=\textwidth}
<<hcl-palettes, fig = TRUE, width = 12, height = 6, echo = FALSE>>=
...
%\bigskip
%
%\textbf{Online versions:} \url{http://hclwizard.org/}
%
%\end{frame}
%
%% ---------------------------------------------------------------------
...
%
%\includegraphics[width=0.9\textwidth]{images/choose_palette_1.png}
%
%\end{frame}
%
%% ---------------------------------------------------------------------
...
%
%\includegraphics[width=0.65\textwidth]{images/choose_color.png}
%
%\end{frame}
%
%% ---------------------------------------------------------------------
...
%
%\includegraphics[width=0.34\textwidth]{images/cvd_emulator_1.png}
%\includegraphics[width=0.34\textwidth]{images/cvd_emulator_2.png}
%
%\end{frame}
%
%\subsection{Base R}
...
\frametitle{Do it yourself}
    ...
    \begin{itemize}
      \item R (mature): \url{http://colorspace.R-Forge.R-project.org/}.
      \item Python (beta): \url{https://github.com/retostauffer/python-colorspace}.
      \item Web (interactive): \url{http://www.hclwizard.org/}.
    \end{itemize}
...
%\textbf{Our goal:}
%\begin{itemize}
%    \item Raise the awareness to avoid using inefficient color maps.
%    \item Provide tools to chose and modify efficient color maps.
%    \item Offer tools to assess color palettes to identify possible problems.
%\end{itemize}
%\bigskip
%
%\textbf{Guidelines:}
%\begin{itemize}
%    \item Avoid large areas of vivid colors.
%    \item Areas of interest should stand out from background.
%    \item Choose type of palette based on the data to be visualized.
%    \item Check color maps used: visual constraints, effectiveness.
%\end{itemize}
%
%\end{frame}
%
%% ---------------------------------------------------------------------
%\begin{frame}
%\frametitle{Software, Tools and Information}
%
%    \textbf{R package:}
%    \begin{itemize}
%      \item \pkg{colorspace} facilitates exploration, manipulation, and assessment.
%      \item \url{http://colorspace.r-forge.r-project.org/}
%    \end{itemize}
%    
%    \bigskip
%    \textbf{Python package:}
%    \begin{itemize}
%        \item \pkg{colorspace}; package still in $\beta$-state.
%        \item \href{https://github.com/retostauffer/python-colorspace}{https://github.com/retostauffer/python-colorspace}
%    \end{itemize}
%
%    \bigskip
%    \textbf{Web interface:}
%    \begin{itemize}
%        \item \url{http://hclwizard.org/}; interactive tools and more information.
%    \end{itemize}
%
%\end{frame}
...
Zeileis A, Fisher JC, Hornik K, Ihaka R, McWhite CD, Murrell P, Stauffer R, Wilke CO (2020).
  ...
  Forthcoming in \emph{Journal of Statistical Software}, preprint available from
