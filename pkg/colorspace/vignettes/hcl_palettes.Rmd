...
| Sequential  | Constant (= single-hue) _or_ | Linear (+ power) _or_ | Linear (+ power) |
|             | Linear (= multi-hue)         | Triangular (+ power)  |                  |
| Diverging   | Constant (2x)                | Linear (+ power) _or_ | Linear (+ power) |
|             |                              | Triangular (+ power)  |                  |
|             |                              |                       |                  |
...
svg(file = "screenshots/hcl-trajectories.svg", width = 11.5, height = 4.0)
