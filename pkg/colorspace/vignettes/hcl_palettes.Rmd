...
All except the last one are inspired by the _ColorBrewer.org_ palettes with
...
Meanwhile, base R has also adopted the HCL-based palettes from _colorspace_ into the `hcl.colors()`
function in _grDevices_ [@color:grDevices]. This provides all the named palettes introduced in
