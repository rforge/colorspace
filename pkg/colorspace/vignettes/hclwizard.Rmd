...
_shiny_ apps [@color:shiny]. All of these GUIs/apps can either be run locally
...
In addition to the _shiny_ version, the _palette constructor_ app is also available as a Tcl/Tk GUI via R package
