...
The next example uses a diverging scale. First consider the plot with the unmodified "Blue-Yellow" palette:
...
gg + scale_fill_continuous_diverging(palette = "Blue-Yellow")
```
...
gg + scale_fill_continuous_diverging(palette = "Blue-Yellow", rev = TRUE, p2 = 2)
```
