...
* `LUV` and `LAB` were therefore proposed by the CIE as perceptually uniform
  ...
  [@color:Wiki+CIELUV:2007; @color:Wiki+CIELAB:2007]
...
For working with these colorspaces various utilities are available:

* `as()` method: Conversions of a `color` object to the various colorspaces,
  e.g., `as(x, "sRGB").
