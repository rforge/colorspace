#' Discrete Flexible Diverging Scales for ggplot2
#'
#' Discrete ggplot2 color scales using the color palettes generated by \code{\link{divergex_hcl}}.
#' 
#' Available CARTO palettes: ArmyRose, Earth, Fall, Geyser, TealRose, Temps
#' (all requiring the flexibility of \code{divergex_hcl}), and
#' Tropic (also available in \code{diverge_hcl}).
#'
#' Available ColorBrewer.org palettes: Spectral, RdYlGn, RdYlBu, RdGy
#' (requiring the flexibility of \code{divergex_hcl}), and BrBG, PiYG,
#' PRGn, PuOr, RdBu (also available in \code{diverge_hcl}).
#' 
...
#' @param h1,h2,h3,c1,c2,c3,l1,l2,l3,p1,p2,p3,p4,cmax1,cmax2 Parameters to customize the scale. See \code{\link{divergex_hcl}} for details.
...
#'   scale_color_discrete_divergex()
#' 
#' # color scale "Tropic"
#' ggplot(iris, aes(Sepal.Length, fill = Species)) +
#'   geom_density(alpha = 0.7) + theme_classic() +
#'     scale_fill_discrete_divergex(palette = "Tropic", rev = TRUE)
#'     
#' # use `nmax` and `order` to skip some colors
#' ggplot(iris, aes(Sepal.Length, fill = Species)) +
#'   geom_density(alpha = 0.7) + theme_classic() +
#'     scale_fill_discrete_divergex(palette = "Tropic", nmax = 5, order = c(1, 4, 5))
#' @importFrom stats na.omit
#' @export
scale_colour_discrete_divergex <- function(palette = "Geyser", c1 = NULL, c2 = NULL, c3 = NULL,
                                           ...
                                           aesthetics = "colour", ...)
{
  # arguments we want to hand off to function divergex_hcl only if explicitly provided
  ...
  pal <- function(n) {
    ...
    do.call(divergex_hcl, args, envir = parent.frame())[order]
  }
  ggplot2::discrete_scale(aesthetics, "manual", pal, ...)
}

#' @rdname scale_colour_discrete_divergex
#' @export
scale_color_discrete_divergex <- function(...) scale_colour_discrete_divergex(...)

#' @rdname scale_colour_discrete_divergex
#' @export
scale_fill_discrete_divergex <- function(...) scale_colour_discrete_divergex(..., aesthetics = "fill")

  
  
#' Continuous Flexible Diverging Scales for ggplot2
#'
#' Continuous ggplot2 color scales using the color palettes generated by \code{\link{divergex_hcl}}.
#'
#' Available CARTO palettes: ArmyRose, Earth, Fall, Geyser, TealRose, Temps
#' (all requiring the flexibility of \code{divergex_hcl}), and
#' Tropic (also available in \code{diverge_hcl}).
...
#' named palette. This enables easy customization of named palettes.
#' 
#' @inheritParams scale_colour_discrete_divergex
#' @param h1,h2,h3,c1,c2,c3,l1,l2,l3,p1,p2,p3,p4,cmax1,cmax2 Parameters to customize the scale. See \code{\link{divergex_hcl}} for details.
...
#' 
#' # default settings
#' gg + scale_color_continuous_divergex()
#' 
#' # switch palette to ArmyRose
#' gg + scale_color_continuous_divergex(palette = "ArmyRose")
#' 
#' # select a range out of the entire palette
#' gg + scale_color_continuous_divergex(palette = "ArmyRose", begin = .2, end = .8)
#' 
#' # volcano plot
#' nx = 87
#' ny = 61
...
#'   geom_raster() + scale_fill_continuous_divergex(palette = "Fall", rev = TRUE) +
...
#' gg + scale_fill_continuous_divergex(palette = "Geyser")
#'
#' # plot with diverging scale "ArmyRose"
#' gg + scale_fill_continuous_divergex(palette = "ArmyRose")
#' @importFrom stats na.omit
#' @export
scale_colour_continuous_divergex <- function(palette = "Geyser", c1 = NULL, c2 = NULL, c3 = NULL,
                                             l1 = NULL, l2 = NULL, l3 = NULL, h1 = NULL, h2 = NULL,
                                             h3 = NULL, p1 = NULL, p2 = NULL, p3 = NULL, p4 = NULL,
                                             ...
                                             guide = "colourbar", n_interp = 11, aesthetics = "colour", ...)
{
  ...
  colors <- do.call(divergex_hcl, args, envir = parent.frame())
  
  # diverging scale
  rescaler = mid_rescaler(mid)
  ggplot2::continuous_scale(aesthetics, "continuous_divergex",
                            scales::gradient_n_pal(colors, values = NULL),
                            na.value = na.value, guide = guide,
                            rescaler = rescaler, ...)
}

#' @rdname scale_colour_continuous_divergex
#' @export
scale_color_continuous_divergex <- function(...) scale_colour_continuous_divergex(...)

#' @rdname scale_colour_continuous_divergex
#' @export
scale_fill_continuous_divergex <- function(...) scale_colour_continuous_divergex(..., aesthetics = "fill")
