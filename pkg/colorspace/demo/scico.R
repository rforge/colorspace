...
scico_seq <- c("Oslo", "Lajolla", "Turku", "Batlow")
for(i in scico_seq) specplot(rev(scico::scico(9, palette = tolower(i))), sequential_hcl(9, i, rev = i %in% c("Lajolla", "Batlow")), main = i)
