...
for(i in carto_seq) specplot(rcartocolor::carto_pal(7, i), sequential_hcl(7, i, rev = !grepl("ag_", i)), main = i, rgb = FALSE)

carto_divx <- c("ArmyRose", "Earth", "Fall", "Geyser", "TealRose", "Temps", "Tropic")
for(i in carto_divx) specplot(rcartocolor::carto_pal(7, i), divergingx_hcl(7, i, rev = i == "ArmyRose"), main = i, rgb = FALSE)
